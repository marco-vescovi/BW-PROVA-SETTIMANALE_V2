...
<p class="has-text-align-right has-text-color" style="color:#d1d1d1;line-height:1.8">Design by: <a class="credlink" href="https://www.sktthemes.org/" rel="nofollow" target="_blank">SKT Themes</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
